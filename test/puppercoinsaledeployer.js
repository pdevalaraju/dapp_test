const PupperCoinSaleDeployer = artifacts.require('PupperCoinSaleDeployer');
const PupperCoinSale = artifacts.require('PupperCoinSale');
const PupperCoin = artifacts.require('PupperCoin');
